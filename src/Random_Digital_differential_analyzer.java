...
public class Random_Digital_differential_analyzer implements GLEventListener {
	...
	public static void main(String[] args) {
		...
		Random_Digital_differential_analyzer l = new Random_Digital_differential_analyzer();
		// creating frame
